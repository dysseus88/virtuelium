...
if(DOXYGEN_FOUND)
    ...
    PATHS  "${CMAKE_CURRENT_SOURCE_DIR}" "${DOXYGEN_SRC_PATH}" "${DOC_PATH}" "${CMAKE_ROOT}/Modules/"
    NO_DEFAULT_PATH
...
if(DOXYGEN_FOUND AND DOXYFILE_IN_FOUND)
    usedoxygen_set_default(DOXYFILE_OUTPUT_DIR "${DOXYFILE_OUTPUT_DIR}"
    ...
    usedoxygen_set_default(DOXYFILE_LATEX YES BOOL "Generate LaTeX API documentation" NO)
    ...
    if(DOXYFILE_LATEX STREQUAL "ON")
        ...
        if(LATEX_COMPILER AND MAKEINDEX_COMPILER AND DOXYFILE_MAKE)
            ...
            if(DOXYGEN_DOT_EXECUTABLE AND DOXYFILE_DOT)
