...
//! @version 5.0.0
//! @date 2013
//! @details This file implements the classes declared in TestRenderer.hpp 
//!  @arg TestRenderer
//! @todo 
//! @remarks 
//!
...
////////////////////////////////////////////////////////////////////////////////
TestRenderer::TestRenderer(int max_depth, Real scale)
    : m_max_depth(max_depth), m_scale(scale) {}
////////////////////////////////////////////////////////////////////////////////
TestRenderer::~TestRenderer(void) { }
////////////////////////////////////////////////////////////////////////////////
void TestRenderer::Init(Scenery& scenery, int nb_threads) {
  //nothing to do more
}
////////////////////////////////////////////////////////////////////////////////
void TestRenderer::InitWithData(Scenery& scenery, 
                                  unsigned char* data, 
                                  unsigned int data_size) {
  Init(scenery, 1);
}
////////////////////////////////////////////////////////////////////////////////
void TestRenderer::ExportData(unsigned char** data, 
                                unsigned int* data_size) {
  data = 0;
  data_size = 0;
}  
////////////////////////////////////////////////////////////////////////////////
void TestRenderer::CastRay(Scenery& scenery, 
...
////////////////////////////////////////////////////////////////////////////////
void TestRenderer::AddDirectSourceContribution(
    Scenery& scenery, 
    LightVector& light_data, 
    Source* source, 
...
////////////////////////////////////////////////////////////////////////////////
void TestRenderer::AddGlossyContribution(
    Scenery& scenery, 
    LightVector& light_data, 
    Object* object, 
    const Basis& localBasis, 
  ...
  for(unsigned int i = 0; i <  subrays.size(); i++) {
    ...
    //                            subrays[i], tmpr);
    for (unsigned int wl = 0; wl < tmpr.size(); wl++)
      tmpr[wl].setRadiance(Real(1.0));

    light_data.add(tmpr);
  }
}
////////////////////////////////////////////////////////////////////////////////
void TestRenderer::AddDirectContribution(
    Scenery& scenery, 
    LightVector& light_data, 
    Object* object, 
    const Basis& localBasis, 
...
////////////////////////////////////////////////////////////////////////////////
void TestRenderer::AddAmbientContribution(
    Scenery& scenery, 
    LightVector& light_data, 
    Object* object, 
    const Basis& localBasis, 
