 ...
 */
#ifndef _SURFACELIGHTSOURCE_HPP
#define _SURFACELIGHTSOURCE_HPP

#include <lightsources/LightSource.hpp>

class SurfaceLightSource : public LightSource{
public :
   ...
   */
  SurfaceLightSource(const Spectrum& spectrum, const Real& power, const Point& o, const Vector& normal);

  /**
   * Virtual destructor
   */
  inline virtual ~SurfaceLightSource();
 ...
 * Virtual destructor.
 */
inline SurfaceLightSource::~SurfaceLightSource()
{
  //Nothing to do !
}
  
#endif //_SURFACELIGHTSOURCE_HPP
