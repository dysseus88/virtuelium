...
#ifndef _LAMBERTIANBRDF_HPP
#define _LAMBERTIANBRDF_HPP
...
public :
   ...
   */
  LambertianBRDF(const Spectrum& reflectance, const Spectrum& transmittance, bool isOpaque);  

  /**
   * Virtual destructor.
   */
  virtual inline ~LambertianBRDF();
...
inline LambertianBRDF::~LambertianBRDF()
{
  //Nothing to do
}

#endif //_LAMBERTIANBRDF_HPP
