...
#ifndef _MAPPEDBRDF_HPP
#define _MAPPEDBRDF_HPP
...
class MappedBRDF : public Material{
public :
  /**
   * Constructor
   ...
   */
  MappedBRDF(std::vector<Material*> materials, std::vector<Image*> maps);  

  /**
   * Virtual destructor.
   */
  virtual inline ~MappedBRDF();
...
private :
   ...
   */
  Real getFactor(unsigned int materialIndex, const Point2D& surfaceCoordinate);
};

inline MappedBRDF::~MappedBRDF()
{
