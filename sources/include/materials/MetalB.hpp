 ...
 *
 */
#ifndef VRT_GUARD_MetalB_HPP
#define VRT_GUARD_MetalB_HPP
//!
//! @file MetalB.hpp
...
class MetalB : public Material {
 public:
  ...
  MetalB(std::vector<const Medium*>& media_stack, 
            Real mi, Real mj); 
