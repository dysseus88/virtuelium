...
class Translation : public ObjectShape{
public :
/**
 * Virtual destructor
 */
virtual inline ~Translation();
 ...
 */
inline Translation(const Vector& translation, ObjectShape* shape);
...
private :
  Vector _translate; //The translation vector
 ...
 */
inline Translation::Translation(const Vector& translation, ObjectShape* shape)
: _translate(translation), _shape(shape)
{
  //Nothing to do
}
