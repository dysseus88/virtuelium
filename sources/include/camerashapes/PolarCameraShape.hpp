...
public :
   ...
   */
  PolarCameraShape(unsigned int width, unsigned int height, const Point& origin);

  /**
   * Virtual destructor.
   */
  virtual inline ~PolarCameraShape();
 ...
 * Virtual destructor.
 */
inline PolarCameraShape::~PolarCameraShape()
{
  //  Nothing to do !
}

#endif //_POLARCAMERASHAPE_HPP
