 ...
 */
#ifndef _ORTHOSCOPICCAMERASHAPE_HPP
#define _ORTHOSCOPICCAMERASHAPE_HPP

#include <camerashapes/CameraShape.hpp>
#include <core/3DBase.hpp>

/**
 * This is an implemntation of the camera shape. This is an orthoscopic camera.
 ...
 */
class OrthoscopicCameraShape : public CameraShape{
public :
  /**
   * Constructor.
   ...
   */
  OrthoscopicCameraShape(unsigned int resx, unsigned int resy, const Real& height, const Point& origin, const Point& lookat, const Vector& up);

  /**
   * Virtual destructor.
   */
  virtual inline ~OrthoscopicCameraShape();
 ...
 * Virtual destructor.
 */
inline OrthoscopicCameraShape::~OrthoscopicCameraShape()
{
  //  Nothing to do !
}

#endif //_ORTHOSCOPICCAMERASHAPE_HPP
